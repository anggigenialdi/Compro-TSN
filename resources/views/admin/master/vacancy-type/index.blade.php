...
@section('main-content')
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-2">
                <h6 class="m-0 font-weight-bold text-primary">Daftar Vacancy Type</h6>
                <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#add-modal">
                    Add
                </button>
                @include('admin.master.vacancy-type.modal-add')
            </div>
    ...
    @include('admin.master.vacancy-type.modal-edit')
@endsection
